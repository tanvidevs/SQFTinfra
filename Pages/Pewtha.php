...
<body>
  ...
  <div class="h-auto py-6 sm:py-8 lg:py-12 mr-0 md:mr-36 ml-0 md:ml-36 flex flex-col md:flex-row">
    <div class="h-auto w-full p-2">
      ...
      <h2 class="text-3xl bg-gradient-to-r from-purple-600 to-pink-600 mt-5 font-bold text-white text-transparent bg-clip-text text-center mb-5">Pewtha Plot Scheme</h2>
